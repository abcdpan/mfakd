...
if __name__ == '__main__':
    ...
    #for i, m in enumerate(net.get_feat_modules()): 7433860.000  1233540.000
    #    print(i, m)
    num_params_stu = (sum(p.numel() for p in net.parameters()))
    print('Total params_stu: {:.3f} '.format(num_params_stu))
