...
from dataset.tinyimagenet import get_imagenet_dataloader
...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='cifar100', choices=['cifar100', 'tiny-imagenet'], help='dataset')
    parser.add_argument('-t', '--trial', type=str, default='', help='the experiment id')
